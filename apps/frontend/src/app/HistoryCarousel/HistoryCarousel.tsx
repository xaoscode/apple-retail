import { HistoryCarouselProps } from "./HistoryCarousel.props";
...
export const HistoryCarousel = ({ ...props }: HistoryCarouselProps): JSX.Element => {
    ...
    return (
        <div className={ styles.carouselContainer } { ...props }>
